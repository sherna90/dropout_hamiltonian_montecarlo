...
mcmc=sampler.sgld(X_train.copy(),y_train.copy(),LOG.loss, LOG.grad, start_p.copy(),hyper_p.copy(), path_length=1,verbose=0)
...
posterior_sample,logp_samples=mcmc.sample(niter,burnin,batch_size=50, backend=backend)

...
mcmc=sampler.sgld_multicore(SOFT.loss, SOFT.grad, start_p.copy(),hyper_p.copy(), path_length=1,verbose=0)
...
posterior_sample,logp_samples=mcmc.multicore_sample(X_train,y_train,niter,burnin,batch_size=50, backend=backend)

...
namespace Eigen {
  ...
  */
  ...
  EigenMultivariateNormal(Matrix<Scalar,Dynamic,1>& mean, Matrix<Scalar,Dynamic,Dynamic>& covar,
    ...
    void setMean(Matrix<Scalar,Dynamic,1>& mean) { _mean = mean; }
    void setCovar(Matrix<Scalar,Dynamic,Dynamic>& covar)
    {
      _covar = covar;

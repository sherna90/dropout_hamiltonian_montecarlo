...
\begin{document}
	...
	\author{\IEEEauthorblockN{Sergio Hern\'andez \thanks{\footnotemark[1] Laboratorio de Procesamiento de Informaci\'on Geoespacial. Universidad Cat\'olica del Maule. Chile.}\footnotemark[1]}
		\IEEEauthorblockA{shernandez@ucm.cl}
		\and
		\IEEEauthorblockN{Jos\'e Vald\'es \thanks{\footnotemark[2] Centro de Innovaci\'on en Ingenier\'ia Aplicada.  Universidad Cat\'olica del Maule. Chile.}\footnotemark[2]}
		\and
		\IEEEauthorblockN{Matias Valdenegro \thanks{\footnotemark[3] German Research Center for Artificial Intelligence, Robotics Innovation Center. Germany.}\footnotemark[3]}
	}

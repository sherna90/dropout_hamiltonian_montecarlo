...
\author[1,2\authfn{1}]{Firstname Middlename Familyname}
\author[2\authfn{2}]{Firstname Initials Surname}
...
\presentadd[\authfn{1}]{Centro de Innovaci\'on en Ingenier\'ia Aplicada, Universidad Cat\'olica del Maule, Chile.}
...
\begin{abstract}
Please provide an abstract of no more than 1500 characters. Your abstract should explain the main contributions of your article, and should not contain any material that is not included in the main text.
\end{abstract}


\section{Introduction (Level 1 heading)}

This is a detailed template for paper submissions to the \CRoNeVERSION{}. This files are based on the \textit{eLife} template for journal submissions authored by \href{https://www.overleaf.com}{Overleaf} and \href{https://www.elifesciences.com}{eLife}, accessed and downloaded at June 9, 2018, from \url{https://www.overleaf.com/latex/templates/elife-latex-template/csqxykvsnyxm#.WxxIbxzathF}.

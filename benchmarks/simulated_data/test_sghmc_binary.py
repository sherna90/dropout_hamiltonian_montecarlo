...
hyper_p={'alpha':alpha}
mcmc=sghmc.SGHMC(X_train,y_train,logistic.loss, logistic.grad, start_p,hyper_p, path_length=1,step_size=0.001,verbose=1)
posterior_sample,logp_samples=mcmc.sample(1e2,1e2,batch_size=20)

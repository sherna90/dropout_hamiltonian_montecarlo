...
# Read in the data
X_cpu = np.loadtxt(data_path+'X_train.csv',delimiter=',',dtype=np.float32)
Y_cpu = np.loadtxt(data_path+'Y_train.csv',delimiter=',',dtype=np.float32)
Y_cpu=lb.fit_transform(Y_cpu)
X_test_cpu = np.loadtxt(data_path+'X_test.csv',delimiter=',',dtype=np.float32)
Y_test_cpu = np.loadtxt(data_path+'Y_test.csv',delimiter=',',dtype=np.float32)
Y_test_cpu=lb.fit_transform(Y_test_cpu)
